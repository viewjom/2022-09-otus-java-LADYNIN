...
public class DbServiceClientImpl implements DBServiceClient {
    ...
    MyProducer producer = new MyProducer(new Utils().getKafkaAddress());
    ...
    public DbServiceClientImpl(TransactionManager transactionManager, ClientRepository clientRepository, RabbitMqServiceImpl rabbitMqService) throws IOException {
    ...
    public  String getRoleName2(Long id) {

        try {
            JdbcTemplate jdbcTemplate = new JdbcTemplate();
            String SQL = "select name from t_role where id = ?";
